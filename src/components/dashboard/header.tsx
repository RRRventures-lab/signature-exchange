      ...
      <div className="flex items-center gap-3">
        <div className="relative group">
          ...
          <input
            ...
            className="pl-9 pr-8 py-1.5 bg-gray-100 border-none rounded-md text-xs font-medium focus:outline-none focus:ring-2 focus:ring-[#0070F3]/20 w-48 transition-all hover:bg-white hover:shadow-sm focus:bg-white focus:shadow-sm"
          />
          {searchQuery && (
            <button
